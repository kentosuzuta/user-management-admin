...
export const DEMO_COM_INFO = "com_001";

export const USERS: UserOutDto[] = [
  {
    id: "u_001",
    name: "テスト 太郎",
...
export const DEFAULT_SETTINGS: SettingsOutDto = {
...
export const SETTINGS_BY_COM: Record<string, SettingsOutDto> = {
  [DEMO_COM_INFO]: { ...DEFAULT_SETTINGS },
};
